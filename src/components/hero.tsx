...
export default function Hero({ downloadLink }: { downloadLink: string }) {
  return (
    <div className="bg-gray-200 dark:bg-gray-900 lg:pb-20 pb-16 lg:pt-2 overflow-hidden md:grid md:place-items-center hero-section">
